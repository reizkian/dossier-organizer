...
__ref.getField(false,"_propertiespanel" /*RemoteObject*/ ).runMethod(true,"setVisible",scandocumentpage.__c.getField(true,"False"));
 BA.debugLineNum = 62;BA.debugLine="DocumentPropertiesButton.Visible = False";
...
__ref.getField(false,"_documentpropertiesbutton" /*RemoteObject*/ ).runMethod(true,"setVisible",scandocumentpage.__c.getField(true,"False"));
 BA.debugLineNum = 63;BA.debugLine="SaveDocumentButton.Visible = False";
...
scandocumentpage._propertiespanel = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");__ref.setField("_propertiespanel",scandocumentpage._propertiespanel);
 //BA.debugLineNum = 25;BA.debugLine="Private OpenGalleryButton As Panel";
scandocumentpage._opengallerybutton = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");__ref.setField("_opengallerybutton",scandocumentpage._opengallerybutton);
 //BA.debugLineNum = 27;BA.debugLine="Private ScrollViewProperties As ScrollView";
...
try {
		Debug.PushSubsStack("DocumentPropertiesButton_Click (scandocumentpage) ","scandocumentpage",2,__ref.getField(false, "ba"),__ref,203);
if (RapidSub.canDelegate("documentpropertiesbutton_click")) { return __ref.runUserSub(false, "scandocumentpage","documentpropertiesbutton_click", __ref);}
 BA.debugLineNum = 203;BA.debugLine="Private Sub DocumentPropertiesButton_Click";
Debug.ShouldStop(1024);
 BA.debugLineNum = 204;BA.debugLine="If PropertiesPanel.Visible == False Then";
...
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_propertiespanel" /*RemoteObject*/ ).runMethod(true,"getVisible"),scandocumentpage.__c.getField(true,"False"))) { 
 BA.debugLineNum = 205;BA.debugLine="PropertiesPanel.Visible = True";
Debug.ShouldStop(4096);
__ref.getField(false,"_propertiespanel" /*RemoteObject*/ ).runMethod(true,"setVisible",scandocumentpage.__c.getField(true,"True"));
 BA.debugLineNum = 206;BA.debugLine="ScrollViewProperties.Panel.LoadLayout(\"propertie";
...
__ref.getField(false,"_scrollviewproperties" /*RemoteObject*/ ).runMethod(false,"getPanel").runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("properties_panel")),__ref.getField(false, "ba"));
 BA.debugLineNum = 207;BA.debugLine="SavePropertiesButton.Visible = False";
...
__ref.getField(false,"_savepropertiesbutton" /*RemoteObject*/ ).runMethod(true,"setVisible",scandocumentpage.__c.getField(true,"False"));
 BA.debugLineNum = 208;BA.debugLine="DocumentPropertiesButton.Visible = False";
Debug.ShouldStop(32768);
__ref.getField(false,"_documentpropertiesbutton" /*RemoteObject*/ ).runMethod(true,"setVisible",scandocumentpage.__c.getField(true,"False"));
 BA.debugLineNum = 209;BA.debugLine="SaveDocumentButton.Visible = True";
...
__ref.getField(false,"_savedocumentbutton" /*RemoteObject*/ ).runMethod(true,"setVisible",scandocumentpage.__c.getField(true,"True"));
 ...
 BA.debugLineNum = 211;BA.debugLine="PropertiesPanel.Visible = False";
Debug.ShouldStop(262144);
__ref.getField(false,"_propertiespanel" /*RemoteObject*/ ).runMethod(true,"setVisible",scandocumentpage.__c.getField(true,"False"));
 BA.debugLineNum = 212;BA.debugLine="SavePropertiesButton.Visible = False";
...
try {
		Debug.PushSubsStack("image_chooser_Result (scandocumentpage) ","scandocumentpage",2,__ref.getField(false, "ba"),__ref,152);
...
Debug.locals.put("pFileName", _pfilename);
 BA.debugLineNum = 152;BA.debugLine="Sub image_chooser_Result (Success As Boolean, pDir";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 154;BA.debugLine="Log(\"execute Chooser_Result\")";
Debug.ShouldStop(33554432);
scandocumentpage.__c.runVoidMethod ("LogImpl","01114114",RemoteObject.createImmutable("execute Chooser_Result"),0);
...
if (RemoteObject.solveBoolean("=",_success,scandocumentpage.__c.getField(true,"True"))) { 
 BA.debugLineNum = 156;BA.debugLine="Log(\"fileDir: \" & pDir)";
Debug.ShouldStop(134217728);
scandocumentpage.__c.runVoidMethod ("LogImpl","01114116",RemoteObject.concat(RemoteObject.createImmutable("fileDir: "),_pdir),0);
 BA.debugLineNum = 157;BA.debugLine="Log(\"fileName: \" & pFileName)";
Debug.ShouldStop(268435456);
scandocumentpage.__c.runVoidMethod ("LogImpl","01114117",RemoteObject.concat(RemoteObject.createImmutable("fileName: "),_pfilename),0);
 BA.debugLineNum = 159;BA.debugLine="Dim bmp As B4XBitmap";
Debug.ShouldStop(1073741824);
...
try { BA.debugLineNum = 161;BA.debugLine="bmp = LoadBitmapSample(pDir,pFileName, Max(scan";
Debug.ShouldStop(1);
_bmp = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper"), scandocumentpage.__c.runMethod(false,"LoadBitmapSample",(Object)(_pdir),(Object)(_pfilename),(Object)(BA.numberCast(int.class, scandocumentpage.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, __ref.getField(false,"_scanview" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_scanview" /*RemoteObject*/ ).runMethod(true,"getHeight")))))),(Object)(BA.numberCast(int.class, scandocumentpage.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, __ref.getField(false,"_scanview" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_scanview" /*RemoteObject*/ ).runMethod(true,"getHeight"))))))).getObject());
 BA.debugLineNum = 162;BA.debugLine="bmp = bmp.Resize(scanView.Width, scanView.Heigh";
Debug.ShouldStop(2);
...
__ref.getField(false,"_documentpropertiesbutton" /*RemoteObject*/ ).runMethod(true,"setVisible",scandocumentpage.__c.getField(true,"True"));
 BA.debugLineNum = 168;BA.debugLine="SaveDocumentButton.Visible = False";
Debug.ShouldStop(128);
__ref.getField(false,"_savedocumentbutton" /*RemoteObject*/ ).runMethod(true,"setVisible",scandocumentpage.__c.getField(true,"False"));
 BA.debugLineNum = 170;BA.debugLine="ScanDocumentButton.Visible = False";
...
__ref.getField(false,"_scandocumentbutton" /*RemoteObject*/ ).runMethod(true,"setVisible",scandocumentpage.__c.getField(true,"False"));
 BA.debugLineNum = 171;BA.debugLine="OpenGalleryButton.Visible = False";
Debug.ShouldStop(1024);
__ref.getField(false,"_opengallerybutton" /*RemoteObject*/ ).runMethod(true,"setVisible",scandocumentpage.__c.getField(true,"False"));
 BA.debugLineNum = 172;BA.debugLine="Log(\"success read image file\")";
Debug.ShouldStop(2048);
scandocumentpage.__c.runVoidMethod ("LogImpl","01114132",RemoteObject.createImmutable("success read image file"),0);
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e18) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e18.toString()); BA.debugLineNum = 174;BA.debugLine="Log(LastException)";
Debug.ShouldStop(8192);
scandocumentpage.__c.runVoidMethod ("LogImpl","01114134",BA.ObjectToString(scandocumentpage.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 };
 }else {
 BA.debugLineNum = 177;BA.debugLine="ToastMessageShow(\"failed read image file\",True)";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("lblBack_Click (scandocumentpage) ","scandocumentpage",2,__ref.getField(false, "ba"),__ref,71);
if (RapidSub.canDelegate("lblback_click")) { return __ref.runUserSub(false, "scandocumentpage","lblback_click", __ref);}
 BA.debugLineNum = 71;BA.debugLine="Sub lblBack_Click";
Debug.ShouldStop(64);
 BA.debugLineNum = 72;BA.debugLine="If PropertiesPanel.Visible Then";
Debug.ShouldStop(128);
if (__ref.getField(false,"_propertiespanel" /*RemoteObject*/ ).runMethod(true,"getVisible").<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 73;BA.debugLine="PropertiesPanel.Visible=False";
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 77;BA.debugLine="B4XPages.ClosePage(Me)";
Debug.ShouldStop(4096);
scandocumentpage._b4xpages.runVoidMethod ("_closepage" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref));
 BA.debugLineNum = 78;BA.debugLine="scanView.SetBitmap(Null)";
Debug.ShouldStop(8192);
__ref.getField(false,"_scanview" /*RemoteObject*/ ).runVoidMethod ("SetBitmap",(Object)((scandocumentpage.__c.getField(false,"Null"))));
 BA.debugLineNum = 81;BA.debugLine="DocumentPropertiesButton.Visible = False";
Debug.ShouldStop(65536);
__ref.getField(false,"_documentpropertiesbutton" /*RemoteObject*/ ).runMethod(true,"setVisible",scandocumentpage.__c.getField(true,"False"));
 BA.debugLineNum = 82;BA.debugLine="SaveDocumentButton.Visible = False";
Debug.ShouldStop(131072);
__ref.getField(false,"_savedocumentbutton" /*RemoteObject*/ ).runMethod(true,"setVisible",scandocumentpage.__c.getField(true,"False"));
 BA.debugLineNum = 84;BA.debugLine="ScanDocumentButton.Visible = True";
Debug.ShouldStop(524288);
__ref.getField(false,"_scandocumentbutton" /*RemoteObject*/ ).runMethod(true,"setVisible",scandocumentpage.__c.getField(true,"True"));
 BA.debugLineNum = 85;BA.debugLine="OpenGalleryButton.Visible = True";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("OpenGalleryButton_Click (scandocumentpage) ","scandocumentpage",2,__ref.getField(false, "ba"),__ref,239);
if (RapidSub.canDelegate("opengallerybutton_click")) { return __ref.runUserSub(false, "scandocumentpage","opengallerybutton_click", __ref);}
 BA.debugLineNum = 239;BA.debugLine="Private Sub OpenGalleryButton_Click";
Debug.ShouldStop(16384);
 BA.debugLineNum = 240;BA.debugLine="Log(\"clicked OpenGalleryButton\")";
Debug.ShouldStop(32768);
scandocumentpage.__c.runVoidMethod ("LogImpl","01376257",RemoteObject.createImmutable("clicked OpenGalleryButton"),0);
 BA.debugLineNum = 241;BA.debugLine="Chooser.Initialize(\"image_chooser\")";
Debug.ShouldStop(65536);
__ref.getField(false,"_chooser" /*RemoteObject*/ ).runVoidMethod ("Initialize",(Object)(RemoteObject.createImmutable("image_chooser")));
 BA.debugLineNum = 242;BA.debugLine="rp.CheckAndRequest(rp.PERMISSION_READ_EXTERNAL_ST";
Debug.ShouldStop(131072);
__ref.getField(false,"_rp" /*RemoteObject*/ ).runVoidMethod ("CheckAndRequest",__ref.getField(false, "ba"),(Object)(__ref.getField(false,"_rp" /*RemoteObject*/ ).getField(true,"PERMISSION_READ_EXTERNAL_STORAGE")));
 BA.debugLineNum = 243;BA.debugLine="Chooser.Show(\"image/*\", \"choose image\")";
Debug.ShouldStop(262144);
...
try {
		Debug.PushSubsStack("saveBlob (scandocumentpage) ","scandocumentpage",2,__ref.getField(false, "ba"),__ref,246);
if (RapidSub.canDelegate("saveblob")) { return __ref.runUserSub(false, "scandocumentpage","saveblob", __ref);}
 BA.debugLineNum = 246;BA.debugLine="Sub saveBlob";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 247;BA.debugLine="outputStream.InitializeToBytesArray(0)";
...
__ref.getField(false,"_outputstream" /*RemoteObject*/ ).runVoidMethod ("InitializeToBytesArray",(Object)(BA.numberCast(int.class, 0)));
 BA.debugLineNum = 248;BA.debugLine="bitMap.WriteToStream(outputStream,100,\"JPEG\")";
Debug.ShouldStop(8388608);
__ref.getField(false,"_bitmap" /*RemoteObject*/ ).runVoidMethod ("WriteToStream",(Object)((__ref.getField(false,"_outputstream" /*RemoteObject*/ ).getObject())),(Object)(BA.numberCast(int.class, 100)),(Object)(BA.getEnumFromString(BA.getDeviceClass("android.graphics.Bitmap.CompressFormat"),RemoteObject.createImmutable("JPEG"))));
 BA.debugLineNum = 249;BA.debugLine="outputStream.Close";
Debug.ShouldStop(16777216);
__ref.getField(false,"_outputstream" /*RemoteObject*/ ).runVoidMethod ("Close");
 BA.debugLineNum = 250;BA.debugLine="Buffer = outputStream.ToBytesArray";
Debug.ShouldStop(33554432);
__ref.setField ("_buffer" /*RemoteObject*/ ,__ref.getField(false,"_outputstream" /*RemoteObject*/ ).runMethod(false,"ToBytesArray"));
 BA.debugLineNum = 251;BA.debugLine="imgStr = stringUtils.EncodeBase64(Buffer)";
Debug.ShouldStop(67108864);
__ref.setField ("_imgstr" /*RemoteObject*/ ,__ref.getField(false,"_stringutils" /*RemoteObject*/ ).runMethod(true,"EncodeBase64",(Object)(__ref.getField(false,"_buffer" /*RemoteObject*/ ))));
 BA.debugLineNum = 252;BA.debugLine="Log(imgStr)";
Debug.ShouldStop(134217728);
scandocumentpage.__c.runVoidMethod ("LogImpl","01441798",__ref.getField(true,"_imgstr" /*RemoteObject*/ ),0);
...
try {
		Debug.PushSubsStack("SaveDocumentButton_Click (scandocumentpage) ","scandocumentpage",2,__ref.getField(false, "ba"),__ref,255);
if (RapidSub.canDelegate("savedocumentbutton_click")) { return __ref.runUserSub(false, "scandocumentpage","savedocumentbutton_click", __ref);}
 BA.debugLineNum = 255;BA.debugLine="Private Sub SaveDocumentButton_Click";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 256;BA.debugLine="SaveProperties";
Debug.ShouldStop(-2147483648);
__ref.runClassMethod (b4a.example.scandocumentpage.class, "_saveproperties" /*RemoteObject*/ );
 BA.debugLineNum = 258;BA.debugLine="If documentName=\"\" Then";
Debug.ShouldStop(2);
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_documentname" /*RemoteObject*/ ),BA.ObjectToString(""))) { 
 BA.debugLineNum = 259;BA.debugLine="MsgboxAsync(\"Please insert document name propert";
Debug.ShouldStop(4);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 262;BA.debugLine="If documentType=\"\" Then";
Debug.ShouldStop(32);
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_documenttype" /*RemoteObject*/ ),BA.ObjectToString(""))) { 
 BA.debugLineNum = 263;BA.debugLine="MsgboxAsync(\"Please insert document type propert";
Debug.ShouldStop(64);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 267;BA.debugLine="saveBlob";
Debug.ShouldStop(1024);
__ref.runClassMethod (b4a.example.scandocumentpage.class, "_saveblob" /*RemoteObject*/ );
 BA.debugLineNum = 269;BA.debugLine="MdlConnection.dbSQL.ExecNonQuery(\"INSERT INTO doc";
Debug.ShouldStop(4096);
scandocumentpage._mdlconnection._dbsql /*RemoteObject*/ .runVoidMethod ("ExecNonQuery",(Object)(RemoteObject.concat(RemoteObject.createImmutable("INSERT INTO documents(DOCUMENT_ID, NAME, TYPE, EXPIRED, SCAN) VALUES('"),__ref.getField(true,"_documentid" /*RemoteObject*/ ),RemoteObject.createImmutable("','"),__ref.getField(true,"_documentname" /*RemoteObject*/ ),RemoteObject.createImmutable("','"),__ref.getField(true,"_documenttype" /*RemoteObject*/ ),RemoteObject.createImmutable("','"),__ref.getField(true,"_documentexpiry" /*RemoteObject*/ ),RemoteObject.createImmutable("','"),__ref.getField(true,"_imgstr" /*RemoteObject*/ ),RemoteObject.createImmutable("')"))));
 BA.debugLineNum = 270;BA.debugLine="ToastMessageShow(\"sucessfully saved document\",Fal";
Debug.ShouldStop(8192);
scandocumentpage.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("sucessfully saved document")),(Object)(scandocumentpage.__c.getField(true,"False")));
 BA.debugLineNum = 272;BA.debugLine="SavePropertiesButton.Visible = False";
Debug.ShouldStop(32768);
__ref.getField(false,"_savepropertiesbutton" /*RemoteObject*/ ).runMethod(true,"setVisible",scandocumentpage.__c.getField(true,"False"));
 BA.debugLineNum = 274;BA.debugLine="DocumentPropertiesButton.Visible = False";
Debug.ShouldStop(131072);
__ref.getField(false,"_documentpropertiesbutton" /*RemoteObject*/ ).runMethod(true,"setVisible",scandocumentpage.__c.getField(true,"False"));
 BA.debugLineNum = 275;BA.debugLine="SaveDocumentButton.Visible = False";
Debug.ShouldStop(262144);
__ref.getField(false,"_savedocumentbutton" /*RemoteObject*/ ).runMethod(true,"setVisible",scandocumentpage.__c.getField(true,"False"));
 BA.debugLineNum = 277;BA.debugLine="ScanDocumentButton.Visible = True";
Debug.ShouldStop(1048576);
__ref.getField(false,"_scandocumentbutton" /*RemoteObject*/ ).runMethod(true,"setVisible",scandocumentpage.__c.getField(true,"True"));
 BA.debugLineNum = 278;BA.debugLine="OpenGalleryButton.Visible = True";
Debug.ShouldStop(2097152);
__ref.getField(false,"_opengallerybutton" /*RemoteObject*/ ).runMethod(true,"setVisible",scandocumentpage.__c.getField(true,"True"));
 BA.debugLineNum = 280;BA.debugLine="scanView.SetBitmap(Null)";
Debug.ShouldStop(8388608);
__ref.getField(false,"_scanview" /*RemoteObject*/ ).runVoidMethod ("SetBitmap",(Object)((scandocumentpage.__c.getField(false,"Null"))));
...
try {
		Debug.PushSubsStack("SaveProperties (scandocumentpage) ","scandocumentpage",2,__ref.getField(false, "ba"),__ref,216);
if (RapidSub.canDelegate("saveproperties")) { return __ref.runUserSub(false, "scandocumentpage","saveproperties", __ref);}
 BA.debugLineNum = 216;BA.debugLine="Private Sub SaveProperties";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 218;BA.debugLine="If docName.Text=\"\" Then";
Debug.ShouldStop(33554432);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_docname" /*RemoteObject*/ ).runMethod(true,"getText"),BA.ObjectToString(""))) { 
 BA.debugLineNum = 219;BA.debugLine="MsgboxAsync(\"Please insert document name\",\"Info\"";
Debug.ShouldStop(67108864);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 222;BA.debugLine="If docType.Text=\"\" Then";
Debug.ShouldStop(536870912);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_doctype" /*RemoteObject*/ ).runMethod(true,"getText"),BA.ObjectToString(""))) { 
 BA.debugLineNum = 223;BA.debugLine="MsgboxAsync(\"Please insert document type\", \"Info";
Debug.ShouldStop(1073741824);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 227;BA.debugLine="documentID = docID.Text";
Debug.ShouldStop(4);
__ref.setField ("_documentid" /*RemoteObject*/ ,__ref.getField(false,"_docid" /*RemoteObject*/ ).runMethod(true,"getText"));
 BA.debugLineNum = 228;BA.debugLine="documentName = docName.Text";
Debug.ShouldStop(8);
__ref.setField ("_documentname" /*RemoteObject*/ ,__ref.getField(false,"_docname" /*RemoteObject*/ ).runMethod(true,"getText"));
 BA.debugLineNum = 229;BA.debugLine="documentType = docType.Text";
Debug.ShouldStop(16);
__ref.setField ("_documenttype" /*RemoteObject*/ ,__ref.getField(false,"_doctype" /*RemoteObject*/ ).runMethod(true,"getText"));
 BA.debugLineNum = 230;BA.debugLine="documentExpiry = docExpiry.Text";
Debug.ShouldStop(32);
__ref.setField ("_documentexpiry" /*RemoteObject*/ ,__ref.getField(false,"_docexpiry" /*RemoteObject*/ ).runMethod(true,"getText"));
 BA.debugLineNum = 232;BA.debugLine="Log(documentID)";
Debug.ShouldStop(128);
scandocumentpage.__c.runVoidMethod ("LogImpl","013434896",__ref.getField(true,"_documentid" /*RemoteObject*/ ),0);
 BA.debugLineNum = 233;BA.debugLine="Log(documentName)";
Debug.ShouldStop(256);
scandocumentpage.__c.runVoidMethod ("LogImpl","013434897",__ref.getField(true,"_documentname" /*RemoteObject*/ ),0);
 BA.debugLineNum = 235;BA.debugLine="PropertiesPanel.Visible=False";
Debug.ShouldStop(1024);
__ref.getField(false,"_propertiespanel" /*RemoteObject*/ ).runMethod(true,"setVisible",scandocumentpage.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("ScanDocumentButton_Click (scandocumentpage) ","scandocumentpage",2,__ref.getField(false, "ba"),__ref,88);
...
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 89;BA.debugLine="TakePicture (scanView.Width, scanView.Height)";
Debug.ShouldStop(16777216);
__ref.runClassMethod (b4a.example.scandocumentpage.class, "_takepicture" /*void*/ ,(Object)(__ref.getField(false,"_scanview" /*RemoteObject*/ ).runMethod(true,"getWidth")),(Object)(__ref.getField(false,"_scanview" /*RemoteObject*/ ).runMethod(true,"getHeight")));
 BA.debugLineNum = 90;BA.debugLine="Wait For Image_Available(Success As Boolean, bmp";
Debug.ShouldStop(33554432);
...
;
 BA.debugLineNum = 91;BA.debugLine="If Success Then";
Debug.ShouldStop(67108864);
if (true) break;
...
try {
		Debug.PushSubsStack("StartActivityForResult (scandocumentpage) ","scandocumentpage",2,__ref.getField(false, "ba"),__ref,181);
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 181;BA.debugLine="Sub StartActivityForResult(i As Intent)";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 182;BA.debugLine="Dim jo As JavaObject = Me";
Debug.ShouldStop(2097152);
...
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), __ref);Debug.locals.put("jo", _jo);
 BA.debugLineNum = 183;BA.debugLine="jo = jo.RunMethod(\"getBA\", Null)";
Debug.ShouldStop(4194304);
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _jo.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getBA")),(Object)((scandocumentpage.__c.getField(false,"Null")))));
 BA.debugLineNum = 184;BA.debugLine="ion = jo.CreateEvent(\"anywheresoftware.b4a.IOnAct";
Debug.ShouldStop(8388608);
__ref.setField ("_ion" /*RemoteObject*/ ,_jo.runMethod(false,"CreateEvent",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("anywheresoftware.b4a.IOnActivityResult")),(Object)(BA.ObjectToString("ion")),(Object)(scandocumentpage.__c.getField(false,"Null"))));
 BA.debugLineNum = 185;BA.debugLine="jo.RunMethod(\"startActivityForResult\", Array(ion,";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("TakePicture (scandocumentpage) ","scandocumentpage",2,__ref.getField(false, "ba"),__ref,107);
...
_i = RemoteObject.createNew ("anywheresoftware.b4a.objects.IntentWrapper");Debug.locals.put("i", _i);
 BA.debugLineNum = 110;BA.debugLine="i.Initialize(\"android.media.action.IMAGE_CAPTURE\"";
Debug.ShouldStop(8192);
_i.runVoidMethod ("Initialize",(Object)(BA.ObjectToString("android.media.action.IMAGE_CAPTURE")),(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 111;BA.debugLine="File.Delete(Provider.SharedFolder, tempImageFile)";
Debug.ShouldStop(16384);
parent.__c.getField(false,"File").runVoidMethod ("Delete",(Object)(__ref.getField(false,"_provider" /*RemoteObject*/ ).getField(true,"_sharedfolder" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_tempimagefile" /*RemoteObject*/ )));
 BA.debugLineNum = 112;BA.debugLine="Dim u As Object = Provider.GetFileUri(tempImageFi";
Debug.ShouldStop(32768);
_u = __ref.getField(false,"_provider" /*RemoteObject*/ ).runClassMethod (b4a.example.fileprovider.class, "_getfileuri" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_tempimagefile" /*RemoteObject*/ )));Debug.locals.put("u", _u);Debug.locals.put("u", _u);
 BA.debugLineNum = 113;BA.debugLine="i.PutExtra(\"output\", u) 'the image will be saved";
Debug.ShouldStop(65536);
...
this.state = 4;
this.catchState = 29;
 BA.debugLineNum = 115;BA.debugLine="StartActivityForResult(i)";
Debug.ShouldStop(262144);
__ref.runClassMethod (b4a.example.scandocumentpage.class, "_startactivityforresult" /*RemoteObject*/ ,(Object)(_i));
 BA.debugLineNum = 116;BA.debugLine="Wait For ion_Event (MethodName As String, Args()";
Debug.ShouldStop(524288);
...
;
 BA.debugLineNum = 117;BA.debugLine="Dim bmp As B4XBitmap";
Debug.ShouldStop(1048576);
_bmp = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper");Debug.locals.put("bmp", _bmp);
 BA.debugLineNum = 118;BA.debugLine="If -1 = Args(0) Then";
Debug.ShouldStop(2097152);
if (true) break;
...
this.state = 10;
this.catchState = 25;
 BA.debugLineNum = 120;BA.debugLine="Dim in As Intent = Args(1)";
Debug.ShouldStop(8388608);
...
_in = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.IntentWrapper"), _args.getArrayElement(false,BA.numberCast(int.class, 1)));Debug.locals.put("in", _in);
 BA.debugLineNum = 121;BA.debugLine="If File.Exists(Provider.SharedFolder, tempImag";
Debug.ShouldStop(16777216);
if (true) break;
...
{ BA.debugLineNum = 135;BA.debugLine="Else If in.HasExtra(\"data\") Then 'try to get t";
Debug.ShouldStop(64);
...
//C
this.state = 13;
 BA.debugLineNum = 122;BA.debugLine="Dim Exif As ExifData";
Debug.ShouldStop(33554432);
_exif = RemoteObject.createNew ("anywheresoftware.b4a.agraham.jpegutils.ExifUtils");Debug.locals.put("Exif", _exif);
 BA.debugLineNum = 123;BA.debugLine="Exif.Initialize(Provider.SharedFolder, tempIm";
Debug.ShouldStop(67108864);
_exif.runVoidMethod ("Initialize",(Object)(__ref.getField(false,"_provider" /*RemoteObject*/ ).getField(true,"_sharedfolder" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_tempimagefile" /*RemoteObject*/ )));
 BA.debugLineNum = 124;BA.debugLine="bmp = LoadBitmapSample(Provider.SharedFolder,";
Debug.ShouldStop(134217728);
_bmp = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper"), parent.__c.runMethod(false,"LoadBitmapSample",(Object)(__ref.getField(false,"_provider" /*RemoteObject*/ ).getField(true,"_sharedfolder" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_tempimagefile" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, parent.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, _targetwidth)),(Object)(BA.numberCast(double.class, _targetheight))))),(Object)(BA.numberCast(int.class, parent.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, _targetwidth)),(Object)(BA.numberCast(double.class, _targetheight)))))).getObject());
 BA.debugLineNum = 125;BA.debugLine="Log(\"Orientation: \" & Exif.getAttribute(Exif.";
Debug.ShouldStop(268435456);
parent.__c.runVoidMethod ("LogImpl","01048594",RemoteObject.concat(RemoteObject.createImmutable("Orientation: "),_exif.runMethod(true,"getAttribute",(Object)(_exif.getField(true,"TAG_ORIENTATION")))),0);
 BA.debugLineNum = 126;BA.debugLine="Select Exif.getAttribute(Exif.TAG_ORIENTATION";
Debug.ShouldStop(536870912);
if (true) break;
...
//C
this.state = 20;
 BA.debugLineNum = 128;BA.debugLine="bmp = bmp.Rotate(180)";
Debug.ShouldStop(-2147483648);
...
//C
this.state = 20;
 BA.debugLineNum = 130;BA.debugLine="bmp = bmp.Rotate(90)";
Debug.ShouldStop(2);
...
//C
this.state = 20;
 BA.debugLineNum = 132;BA.debugLine="bmp = bmp.Rotate(270)";
Debug.ShouldStop(8);
...
this.state = 23;
;
 BA.debugLineNum = 134;BA.debugLine="bmp = bmp.Resize(TargetWidth, TargetHeight, T";
Debug.ShouldStop(32);
...
//C
this.state = 23;
 BA.debugLineNum = 136;BA.debugLine="Dim jo As JavaObject = in";
Debug.ShouldStop(128);
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _in.getObject());Debug.locals.put("jo", _jo);
 BA.debugLineNum = 137;BA.debugLine="bmp = jo.RunMethodJO(\"getExtras\", Null).RunMe";
Debug.ShouldStop(256);
...
this.state = 26;
;
 BA.debugLineNum = 139;BA.debugLine="bitMap = bmp";
Debug.ShouldStop(1024);
__ref.setField ("_bitmap" /*RemoteObject*/ ,_bmp);
 Debug.CheckDeviceExceptions();
if (true) break;
...
this.state = 26;
this.catchState = 29;
 BA.debugLineNum = 141;BA.debugLine="Log(LastException)";
Debug.ShouldStop(4096);
parent.__c.runVoidMethod ("LogImpl","01048610",BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 if (true) break;
if (true) break;
...
this.state = 30;
;
 BA.debugLineNum = 144;BA.debugLine="CallSubDelayed3(Me, \"Image_Available\", bmp.IsIni";
Debug.ShouldStop(32768);
...
this.state = 30;
this.catchState = 0;
 BA.debugLineNum = 146;BA.debugLine="ToastMessageShow(\"Camera is not available.\", Tru";
Debug.ShouldStop(131072);
...
Debug.ShouldStop(262144);
parent.__c.runVoidMethod ("LogImpl","01048616",BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 BA.debugLineNum = 148;BA.debugLine="CallSubDelayed3(Me, \"Image_Available\", False, Nu";
Debug.ShouldStop(524288);
