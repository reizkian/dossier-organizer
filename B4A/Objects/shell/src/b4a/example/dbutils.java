...
public static b4a.example.b4xcollections _b4xcollections = null;
  public Object[] GetGlobals() {
		return new Object[] {"B4XCollections",Debug.moduleToString(b4a.example.b4xcollections.class),"B4XPages",Debug.moduleToString(b4a.example.b4xpages.class),"Main",Debug.moduleToString(b4a.example.main.class),"MdlConnection",Debug.moduleToString(b4a.example.mdlconnection.class),"Starter",Debug.moduleToString(b4a.example.starter.class)};
}
}