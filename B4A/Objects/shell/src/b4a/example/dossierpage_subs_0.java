...
Debug.ShouldStop(4);
dossierpage.__c.runVoidMethod ("LogImpl","03473416",RemoteObject.createImmutable("------ selected documents ------"),0);
...
Debug.ShouldStop(64);
dossierpage.__c.runVoidMethod ("LogImpl","03473420",dossierpage._mdlconnection._dbcursor /*RemoteObject*/ .runMethod(true,"GetString",(Object)(RemoteObject.createImmutable("DOCUMENT_ID"))),0);
 }
}Debug.locals.put("i", _i);
;
...
Debug.ShouldStop(536870912);
dossierpage.__c.runVoidMethod ("LogImpl","03997699",RemoteObject.createImmutable("bridge table content: "),0);
...
Debug.ShouldStop(16);
dossierpage.__c.runVoidMethod ("LogImpl","03997706",(RemoteObject.concat(RemoteObject.createImmutable("dossierID: "),dossierpage.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_dossierid))),RemoteObject.createImmutable(" includedDocs: "),dossierpage.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_docid))),RemoteObject.createImmutable(""))),0);
 }
}Debug.locals.put("i", _i);
;
...
Debug.ShouldStop(8388608);
dossierpage.__c.runVoidMethod ("LogImpl","03932169",RemoteObject.createImmutable("------ RESET DATABASE: hard ------"),0);
...
Debug.ShouldStop(2048);
dossierpage.__c.runVoidMethod ("LogImpl","03866633",RemoteObject.createImmutable("------ RESET DATABASE: selected_doc ------"),0);
...
Debug.ShouldStop(4194304);
dossierpage.__c.runVoidMethod ("LogImpl","03801100",(RemoteObject.concat(RemoteObject.createImmutable("get dossier ID: "),dossierpage.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_dossierid))),RemoteObject.createImmutable(" of "),dossierpage.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(true,"_dossiername" /*RemoteObject*/ )))),RemoteObject.createImmutable(" "))),0);
