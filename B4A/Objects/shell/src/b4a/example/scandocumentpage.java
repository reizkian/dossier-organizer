...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"bitMap",_ref.getField(false, "_bitmap"),"Buffer",_ref.getField(false, "_buffer"),"Chooser",_ref.getField(false, "_chooser"),"DateTemplate",_ref.getField(false, "_datetemplate"),"DateUtils",_ref.getField(false, "_dateutils"),"Dialog",_ref.getField(false, "_dialog"),"docExpiry",_ref.getField(false, "_docexpiry"),"docID",_ref.getField(false, "_docid"),"docName",_ref.getField(false, "_docname"),"docType",_ref.getField(false, "_doctype"),"documentExpiry",_ref.getField(false, "_documentexpiry"),"documentID",_ref.getField(false, "_documentid"),"documentName",_ref.getField(false, "_documentname"),"DocumentPropertiesButton",_ref.getField(false, "_documentpropertiesbutton"),"documentType",_ref.getField(false, "_documenttype"),"imgStr",_ref.getField(false, "_imgstr"),"ion",_ref.getField(false, "_ion"),"lblBack",_ref.getField(false, "_lblback"),"OpenGalleryButton",_ref.getField(false, "_opengallerybutton"),"outputStream",_ref.getField(false, "_outputstream"),"Panel1",_ref.getField(false, "_panel1"),"PropertiesPanel",_ref.getField(false, "_propertiespanel"),"Provider",_ref.getField(false, "_provider"),"Root",_ref.getField(false, "_root"),"rp",_ref.getField(false, "_rp"),"SaveDocumentButton",_ref.getField(false, "_savedocumentbutton"),"SavePropertiesButton",_ref.getField(false, "_savepropertiesbutton"),"ScanDocumentButton",_ref.getField(false, "_scandocumentbutton"),"scanView",_ref.getField(false, "_scanview"),"ScrollView1",_ref.getField(false, "_scrollview1"),"ScrollViewProperties",_ref.getField(false, "_scrollviewproperties"),"stringUtils",_ref.getField(false, "_stringutils"),"tempImageFile",_ref.getField(false, "_tempimagefile"),"xui",_ref.getField(false, "_xui")};
}
}