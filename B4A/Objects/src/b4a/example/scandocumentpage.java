...
__c.LogImpl("81572870",__ref._imgstr /*String*/ ,0);
...
__c.LogImpl("81507345",__ref._documentid /*String*/ ,0);
RDebugUtils.currentLine=1507346;
 //BA.debugLineNum = 1507346;BA.debugLine="Log(documentName)";
__c.LogImpl("81507346",__ref._documentname /*String*/ ,0);
...
parent.__c.LogImpl("81310737","Orientation: "+_exif.getAttribute(_exif.TAG_ORIENTATION),0);
...
parent.__c.LogImpl("81310752",BA.ObjectToString(parent.__c.LastException(ba)),0);
 if (true) break;
if (true) break;
...
parent.__c.LogImpl("81310758",BA.ObjectToString(parent.__c.LastException(ba)),0);
