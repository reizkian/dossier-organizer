...
views.get("documentpropertiesbutton").vw.setLeft((int)((0d / 100 * width)));
views.get("documentpropertiesbutton").vw.setWidth((int)((25d / 100 * width) - ((0d / 100 * width))));
...
//BA.debugLineNum = 33;BA.debugLine="OpenGalleryButton.SetLeftAndRight(75%x,100%x)"[ScanDocument/General script]
views.get("opengallerybutton").vw.setLeft((int)((75d / 100 * width)));
views.get("opengallerybutton").vw.setWidth((int)((100d / 100 * width) - ((75d / 100 * width))));
